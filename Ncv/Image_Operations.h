...
namespace Ncv
{
	...
	namespace Image_Operations
	{
		...
		void CopyImage(MemAccessor_2D_REF(T) a_destAcc, MemAccessor_2D_REF(T) a_srcAcc)
		{
			...
			Ncpp_ASSERT(acc_Src_Y->GetIndexSize() == acc_Dest_Y->GetIndexSize());
		...
		void CalcMagImage(MemAccessor_2D_REF(T) a_inpAcc, MemAccessor_2D_REF(float) a_outAcc)
		{
			...
			Ncpp_ASSERT(acc_Inp_Y->GetIndexSize() ==
		...
		void CalcMagSqrImage(MemAccessor_2D_REF(T) a_inpAcc, MemAccessor_2D_REF(float) a_outAcc)
		{
			...
			Ncpp_ASSERT(acc_Inp_Y->GetIndexSize() == acc_Out_Y->GetIndexSize());
		...
		void AvgImage_Weighted_H(MemAccessor_2D_REF(T) a_inpAcc, MemAccessor_2D_REF(float) a_weightAcc, MemAccessor_2D_REF(T) a_outAcc, Range<int> & a_range_X)
		{
			...
			Ncpp_ASSERT(acc_Inp_Y->GetIndexSize() == acc_Weight_Y->GetIndexSize());
			Ncpp_ASSERT(acc_Inp_Y->GetIndexSize() == acc_Out_Y->GetIndexSize());
			...
			MemAccessor_2D_REF(float) a_outAcc)
		{
			...
			Ncpp_ASSERT(acc_Avg_Y->GetIndexSize() == acc_Avg_MagSqr_Y->GetIndexSize());
			Ncpp_ASSERT(acc_Avg_Y->GetIndexSize() == acc_Out_Y->GetIndexSize());

			//Ncpp_ASSERT(acc_Avg_X->GetIndexSize() == acc_Avg_MagSqr_X->GetIndexSize());
			//Ncpp_ASSERT(acc_Avg_X->GetIndexSize() == acc_Out_X->GetIndexSize());
		...
		{
			Ncpp_ASSERT(a_inpAcc->GetIndexSize_X() == a_magSqrAcc->GetIndexSize_X());
			Ncpp_ASSERT(a_inpAcc->GetIndexSize_X() == a_outAcc->GetIndexSize_X());

			Ncpp_ASSERT(a_inpAcc->GetIndexSize_Y() == a_magSqrAcc->GetIndexSize_Y());
			Ncpp_ASSERT(a_inpAcc->GetIndexSize_Y() == a_outAcc->GetIndexSize_Y());
