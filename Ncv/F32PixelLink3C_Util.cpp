...
namespace Ncv
{
	namespace F32PixelLink3C_Util
	{
		...
		//template<class F32PixelLinkOwner3C, class T_PixelLink, class T_CoreSharedPixelLink >
		...
		//		CoreSharedPixelLinkDiffMag_Initializer<F32PixelLinkOwner3C, F32PixelLink3C, F32CoreSharedPixelLink3C>>(src_Img->AsHolderRef());
